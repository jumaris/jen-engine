...
// GL_ARB_map_buffer_range
  glMapBufferRange: function(target: GLenum; offset: GLint; length: GLsizei; access: GLbitfield): PGLvoid; stdcall;
  glFlushMappedBufferRange: procedure(target: GLenum; offset: GLint; length: GLsizei); stdcall;
